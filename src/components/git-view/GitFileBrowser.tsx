...
export const GIT_FILE_VIEW_MODE_KEY = "fastaf.git.fileViewMode";
...
export function GitFileBrowser<T extends GitFileEntry>({
  ...
  // Track directories already auto-collapsed: each large directory is auto-collapsed only once, after which the user's manual expand/collapse is respected.
  ...
  useEffect(() => {
    ...
    setCollapsedDirs((prev) => {
      ...
      for (const path of autoCollapsedDirs) {
        // Don't force-collapse a directory that was already auto-collapsed, to avoid overriding the user's manual expand after a refresh.
